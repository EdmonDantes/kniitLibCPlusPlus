...
//            number = Number((int32) 0, true);
//        } else if (type == DataTypes::UINT32) {
//            number = Number((uint32) 0, true);
...
//
//            uint16 firstCode = (bytes[0] << 8) + bytes[1];
...
//                uint16 secondCode = ((uint16) bytes[2] << 8) | bytes[3];
//
...
//    }
//
//    Number ReaderInputStream::readColor(uint8 zeroAlpha, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
...
//                    switch (word.length()) {
//                        case 3:
//                            return (((uint32)zeroAlpha) << 24) | (((uint32) (hexToNumber(word[0]) / 15.0 * 255.0)) << 16) | (((uint32) (hexToNumber(word[1]) / 15.0 * 255.0)) << 8) | ((uint32) (hexToNumber(word[2]) / 15.0 * 255.0));
//                        case 4:
//                            return (((uint32) (hexToNumber(word[0]) / 15.0 * 255.0)) << 24) | (((uint32) (hexToNumber(word[1]) / 15.0 * 255.0)) << 16) | (((uint32) (hexToNumber(word[2]) / 15.0 * 255.0)) << 8) | ((uint32) (hexToNumber(word[3]) / 15.0 * 255.0));
//                        case 6:
//                            return (((uint32) zeroAlpha) << 24)
//                                   | (((uint32) hexToNumber(word[0])) << 20) | (((uint32) hexToNumber(word[1])) << 16)
//                                   | (((uint32) hexToNumber(word[2])) << 12) | (((uint32) hexToNumber(word[3])) << 8)
//                                   | (((uint32) hexToNumber(word[4])) << 4) | ((uint32) hexToNumber(word[5]));
//                        case 8:
//                            return (((uint32) hexToNumber(word[0])) << 28) | (((uint32) hexToNumber(word[1])) << 24)
//                                   | (((uint32) hexToNumber(word[2])) << 20) | (((uint32) hexToNumber(word[3])) << 16)
//                                   | (((uint32) hexToNumber(word[4])) << 12) | (((uint32) hexToNumber(word[5])) << 8)
//                                   | (((uint32) hexToNumber(word[6])) << 4) | ((uint32) hexToNumber(word[7]));
//                        default:
//                            if (!skip) {
//                                position(startPosition);
//                            }
...
//                            case 3:
//                                if (haveInt) {
//                                    return (Number((uint32) zeroAlpha) << 24) | (numbers[0] << 16) | (numbers[1] << 8) | (numbers[2]);
//                                } else {
//                                    return (Number((uint32) zeroAlpha) << 24) | ((numbers[0] * 255.0).getUInt() << 16) | ((numbers[1] * 255.00).getUInt() << 8) | (numbers[2] * 255.0).getUInt();
//                                }
//                            case 4:
//                                if (haveInt) {
...
//    }
//
//    List<uint8> ReaderInputStream::readHex(uintmax length, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//        List<uint8> hex;
//
//        uint8 tmp = 0;
...
//            }
//
//            int8 hexToNum = hexToNumber(ch.getInt8());
//            if (hexToNum < 0) {
//                if (!skip) {
//                    position(startPosition);
//                }
