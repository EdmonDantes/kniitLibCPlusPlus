...
//
//#include <fstream>
//#include "../writer_output_stream_old.h"
//
//KNIIT_LIB_NAMESPACE {
...
//            }
//
//            return write(bytes, length, BIG_ENDIAN_BYTE_ORDER);
//        } else {
//            if (ch > 0xffff) {
//                ch -= 0x10000;
...
//    }
//
//    bool WriterOutputStream::writeNumber(Number value, uint8 maxCharAfterPoint, bool unicode, bool utf8, ByteOrder byteOrder) {
//        if (value.isInteger()) {
//            if (value.isUInt()) {
...
//
//    bool
//    WriterOutputStream::writeHex(List<uint8>& value, uintmax length, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//        uintmax count = 0;
...
//    }
//
//    bool WriterOutputStream::writePoint(List<Number>& value, uint8 maxCharAfterPoint, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//        if (!writeChar('(')) {
//            position(startPosition);
//            return false;
...
//    }
//
//    bool WriterOutputStream::writeList(List<Number>& value, uint8 maxCharAfterPoint, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//        if (!writeChar('[')) {
//            position(startPosition);
//            return false;
...
//    }
//
//    bool WriterOutputStream::writeSet(Set<Number>& value, uint8 maxCharAfterPoint, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//        if (!writeChar('{')) {
//            position(startPosition);
//            return false;
...
//    }
//
//    bool WriterOutputStream::writeMatrix(MutableMatrix<Number> &matrix, uint8 maxCharAfterPoint, bool unicode, bool utf8, ByteOrder byteOrder) {
//        uintmax startPosition = position();
//
