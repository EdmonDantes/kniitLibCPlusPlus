...
KNIIT_LIB_NAMESPACE {
    ...
    public:
        ...
        String(List<uint8>& bytes, const Codec* codec, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
        ...
        List<uint8> to(const Codec* codec, bool addZeroToEnd = false, ByteOrder byteOrder = DEFAULT_BYTE_ORDER) const;
