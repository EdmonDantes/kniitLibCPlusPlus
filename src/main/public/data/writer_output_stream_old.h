...
//
//        bool writeNumber(Number value, uint8 maxCharAfterPoint = 6, bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//
...
//
//        bool writeHex(List<uint8>& value, uintmax length = 0, bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//
//        bool writePoint(List<Number>& value, uint8 maxCharAfterPoint = 6, bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//
//        bool writeList(List<Number>& value,  uint8 maxCharAfterPoint = 6, bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//
//        bool writeSet(Set<Number>& value,  uint8 maxCharAfterPoint = 6, bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//
//        bool writeMatrix(MutableMatrix<Number>& matrix, uint8 maxCharAfterPoint = 6,  bool unicode = false, bool utf8 = true, ByteOrder byteOrder = DEFAULT_BYTE_ORDER);
//    };
//};
